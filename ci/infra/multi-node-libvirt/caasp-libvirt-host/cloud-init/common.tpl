...
write_files:
- content: |
    # Generated by terraform - don't drop the "failure-domain.beta.kubernetes.io/region" and "failure-domain.beta.kubernetes.io/zone" labels

    KUBELET_EXTRA_ARGS="--node-labels failure-domain.beta.kubernetes.io/region=${region},failure-domain.beta.kubernetes.io/zone=${zone}"
